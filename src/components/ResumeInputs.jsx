...
function ResumeInputs({resumeDetails,setResumeDetails}) {
  ...
  const renderFromContent = (stepCount)=>{
    switch (stepCount) {
      case 0: return (
        <div>
      ...
      case 2: return (
       ...
       case 3: return (
        <div>
          <p>Our AI will genarate Skills &Summary according to your job role. Click the <b>Generate AI Skills & Summary</b>button to proceed. Once the form get submitted, user won't get the cance to update the details.</p>
        </div>
      )
        break;  
        default: return null
    ...
    <Box sx={{ width: '100%' }}>
      ...
      {activeStep === steps.length ? (
        ...
        <React.Fragment>
          ...
          <Box>
            {/* render form according to activeStep */}
           {
            renderFromContent(activeStep)
            }
          </Box>
          <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
            <Button
            ...
            <Button onClick={genarateSkillAndSummary}>Generate AI Skills & Summary</Button>
            :
